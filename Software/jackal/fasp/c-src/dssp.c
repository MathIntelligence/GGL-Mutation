/***  REMOVE ANY LINE ABOVE  *THIS*  LINE USING A STANDARD TEXT EDITOR !!! 
      ...
      CHECK WHETHER THE FILE HAS BEEN CORRUPTED BY AN EMAIL SERVER:
      THE LAST LINE SHOULD CONTAIN  "END OF PROGRAM DSSP" 

      COMPILE THE PROGRAM ON SUN's WITH "cc dssp.c -o dssp -lm"
      ON DEC-ALPHA WITH                 "cc -DHAS_STDLIB dssp.c -o dssp -lm"
...
This copy for Li Xiao at Univ-Colombia-NY-USA
who have agreed to the  software license agreement.
 */
...
*/
  ...
  printf("This version licensed to Li Xiao at Univ-Colombia-NY-USA               \n");
