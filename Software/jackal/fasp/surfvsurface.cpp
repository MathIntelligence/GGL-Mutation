...
SurfvSurface::SurfvSurface(std::vector<Atom*> a,int spherelevel)
{
int i,n;
...
probe_radius=Application::probe_radius;

sp=new Icosahedron(spherelevel);

gb=new Grid<Atom*>(atom,2.0+probe_radius);
...
float SurfvSurface::Surface(Vector center,float rad,Grid<Atom*> *gridbox,Icosahedron *sphere,float *rplusp2)
{
int j,k,l,nacc;
int iv,ie,ifc,ivm;
